...
import com.guilhermesa.cursomc.dto.ClienteNewDTO;
...
import com.guilhermesa.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getCpfOrCnpj(), TipoCliente.toEnum(objDto.getTipo()), pe.encode(objDto.getSenha()));
