package com.guilhermesa.cursomc;
...
import com.guilhermesa.cursomc.domain.PagamentoComBoleto;
import com.guilhermesa.cursomc.domain.PagamentoComCartao;
import com.guilhermesa.cursomc.domain.Pedido;
import com.guilhermesa.cursomc.domain.Produto;
import com.guilhermesa.cursomc.domain.enuns.EstadoPagamento;
...
import com.guilhermesa.cursomc.repositories.ItemPedidoRepository;
import com.guilhermesa.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat8 = new Categoria(null, "Telefonia");
		...
		Cidade c2 = new Cidade(null, "São Paula", est2);
